...
## TESZT:
## 2) (A) ONLINE – Sequence diagram (GitHub-biztos, “minimal feature set”)
Kivettem az autonumber-t és minden extra “kényes” elemet, hogy a GitHub Mermaid parser biztosan megegye.
```mermaid
